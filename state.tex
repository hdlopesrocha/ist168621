...
\bibitem{ambulant} Video on the Web: Experiences from SMIL and from the Ambulant Annotator - Dick C.A. Bulterman, A.J. Jansen, and Pablo Cesar
\bibitem{smillingweb} A SMIL player for any web browser - Ombretta Gaggi and Luca Danese
\bibitem{hitchcock} Creating Navigable Multi-Level Video Summaries - Frank Shipman, Andreas Girgensohn, Lynn Wilcox
\bibitem{hypercafe} Authoring and Navigating Video in Space and Time - Nitin Sawhney, David Balcom, Ian Smith
\end{thebibliography}
