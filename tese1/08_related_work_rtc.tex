...
\centering
    ...
    \cline{2-5}
                                            & \textbf{TCP}           & \textbf{UDP}              & \textbf{SCTP}            &\\[14pt]\hline
\multicolumn{1}{|c|}{\textbf{Reliability}}           & reliable      & unreliable       & configurable    &\\[14pt]\hline
\multicolumn{1}{|c|}{\textbf{Delivery}}              & ordered       & unordered        & configurable    &\\[14pt]\hline
\multicolumn{1}{|c|}{\textbf{Transmission}}          & byte-oriented & message-oriented & message-oriented&\\[14pt]\hline
\multicolumn{1}{|c|}{\textbf{Flow control}}          & yes           & no               & yes             &\\[14pt]\hline
\multicolumn{1}{|c|}{\textbf{Congestion control}} 	& yes           & no               & yes             &\\[14pt]\hline
\end{tabular}
