...
Skype is an application that allows video, voice and instant messaging communication, its main strength is the amount of users that are using it nowadays. But compared to Skype, \ac{WebRTC} is an open source technology that allows web browser real time communications without installing any aditional application or plugin.
