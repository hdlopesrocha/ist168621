...
\textit{Jitsi Meet}\footnote{\url{http://jitsi.org/Projects/JitsiMeet}} is a \ac{WebRTC} collaborative application that uses \textit{Jitsi Videobridge} for high quality and scalable video conferences and supports shared document editing. \textit{Jitsi Videobridge} is a server that enables multi-party video calls.
