\section{Solution deployment}
	...
	The hardware was gently provided by INESC-ID\footnote{\url{http://www.inesc-id.pt/} (Accessed March 26, 2016)}. The specifications of the server that we used are described in Table \ref{table:hwspecs}.
